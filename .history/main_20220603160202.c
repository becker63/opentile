...
int main()
{
  ...
  XMoveWindow(display, windows[k].id, px, h);
  XFlush(display);
   ...
   printf("%ix%i\n%ix%i\n\n%ix%i\n%ix%i", windows[j].screenx, windows[j].screeny,windows[k].screenx, windows[k].screeny,windows[j].screenx, windows[j].screeny,windows[k].screenx, windows[k].screeny);
   return 0;
