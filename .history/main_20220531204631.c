...
int main()
{
  ...
  int screeny = screen->height - windows[j].screeny - 50;

  int screenx = screen->height - windows[j].screeny / 2;
  ...
  printf("%d\n", screenbuf);
   ...
   //XMoveWindow(display, windows[j].id, windows[j].screenx + 10, windows[j].screeny +  10);

   XResizeWindow(display, windows[j].id, windows[j].sizex + 30, windows[j].sizey +  30);
