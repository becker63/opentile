...
int main()
{
  ...
  int sizex = screen->width;
   ...
   printf("\n\n\n\n\n0 pos: %ix%i\n1 pos: %ix%i\n\n0 size: %ix%i\n1 size: %ix%i", windows[0].screenx, windows[0].screeny,windows[1].screenx, windows[1].screeny,windows[0].sizex, windows[0].sizey,windows[1].sizex, windows[1].sizey,sizex,sizey);
   return 0;
