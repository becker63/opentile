...
int main()
{
  ...
  windowinit(display, root);
   ...
   printf("0 pos: %ix%i\n1 pos: %ix%i\n\n0 size: %ix%i\n1 size: %ix%i\n\nssizex:%i\nssizey:%i", windows[0].screenx, windows[0].screeny,windows[k].screenx, windows[k].screeny,windows[0].sizex, windows[0].sizey,windows[k].sizex, windows[k].sizey,sizex,sizey);
   return 0;
