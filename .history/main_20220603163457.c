...
int main()
{
  ...
  Screen *screen = ScreenOfDisplay(display, 0);
   ...
   printf("0 pos: %ix%i\n1 pos: %ix%i\n\n0 size: %ix%i\n1 size: %ix%i\n\nssizex:%i\nssizey:%i", windows[0].screenx, windows[0].screeny,windows[1].screenx, windows[1].screeny,windows[0].sizex, windows[0].sizey,windows[1].sizex, windows[1].sizey,sizex,sizey);
   return 0;
